    ...
    return (
        <div className="w-full max-w-3xl mx-auto">
            <div className="flex justify-between mb-3">
                ...
                <span className="text-gray-500">{remainingUploads} credits remaining</span>
            </div>
            ...
            <div
                ...
                className={`border-2 border-dashed rounded-xl bg-white py-2 text-center transition-colors cursor-pointer hover:border-blue-400 ${uploading ? 'pointer-events-none opacity-[0.5]' : ''}`}
            >
                <input
                    ref={fileInputRef}
                    type="file"
                ...
                <div className="text-gray-500 text-sm">
                    or click to browse ({remainingUploads} credits remaining)
                </div>
            </div>
                ...
                files.length > 0 && (
                    <div className="mt-4 bg-gray-50 p-4 rounded-lg">
                        ...
                        <button
                            onClick={onUpload}
                            disabled={uploading}
                            className={`mt-4 w-full py-3 rounded-md font-medium text-white text-center cursor-pointer ${uploading ? "bg-blue-300 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"}`}
                        >
