...
import { File, Globe, Lock, Copy, Download, Trash2, Eye, Image, Video, Music, FileText, FileIcon } from "lucide-react";
import GetFileIcon from "./GetFileIcon";

const RecentFiles = ({ files, setFiles }) => {
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Recent Files {files.length}</h2>
            </div>
                ...
                files.length === 0 ? (
                    <div className="bg-white rounded-lg shadow p-12 flex flex-col items-center justify-center">
                        ...
                        <p className="text-gray-500 text-center max-w-md mb-6">
                            Upload files to see your most recent files here.
                        </p>
