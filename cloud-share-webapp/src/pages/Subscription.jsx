                    ...
                    try {
                        ...
                        if (verifyResponse.data.success) {
                            if (verifyResponse.data.credits) {
                                ...
                                console.log('Credits not in response, fetchng latest credits');
            ...
            <div className="p-6">
                ...
                <div className="flex flex-col md:flex-row gap-6 mb-8">
                    <div className="bg-blue-50 p-6 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600 mt-2">
                            You can upload {credits} more files with you current credits.
                        </p>
                    </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {
                        plans.map((plan) => (
                            ...
                            >
                                {
                                    plan.recommended && (
                                        <div className="inline-block bg-purple-500 text-white text-[10px] font-semibold rounded-full px-2 py-0.5 mb-2">
                                            RECOMMENDED
                                        </div>
                                    )
                                }
                                ...
                                <button
                                    ...
                                    className={`w-full py-2 rounded-md font-medium transition-colors ${plan.recommended ? 'bg-purple-500 text-white hover:bg-purple-600' : 'bg-white border border-purple-500 text-purple-500 hover:bg-purple-200'} disabled:opacity-50 flex items-center justify-center gap-2 cursor-pointer`}
                                >
                                    {
                                        processingPayment ? (
                                            <>
                ...
                <div className="mt-8 bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600">
                        Each file upload consumes 1 credit. New users start with 5 free credits. Credits never expire and can be used at any time. If you run out of credits, you can purchase more through one of our plans above.
                    </p>
                </div>
            </div>
        </DashbardLayout>
