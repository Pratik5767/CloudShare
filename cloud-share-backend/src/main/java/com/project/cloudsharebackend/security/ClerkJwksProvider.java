package com.project.cloudsharebackend.security;
...
public class ClerkJwksProvider {
    ...
    private PublicKey createPublicKey(String modules, String exponent) throws Exception {
        byte[] modulesBytes = Base64.getUrlDecoder().decode(modules);
